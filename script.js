...
const translations = {
  hu: {
    ...
    "contact.trustTitle": "Díjmentes, kötelezettség nélküli első válasz.",
    "contact.trustText": "Ha az űrlap technikai okból nem menne át, írj közvetlenül: hello@da-technology.eu",
    "contact.companyNameLabel": "Cégnév",
    "contact.companyTaxLabel": "Adószám",
    "contact.companyAddressLabel": "Székhely",
    "contact.proofResponseLabel": "Válaszidő",
    "contact.proofResponseText": "24 órán belül",
    "contact.proofStartLabel": "Első lépés",
    "contact.proofStartText": "Díjmentes egyeztetés",
    "contact.proofOfferLabel": "Ajánlat",
    "contact.proofOfferText": "Tiszta, átlátható irány",
    "form.name": "Név",
    ...
    "trust.legalKicker": "Céges háttér",
    "trust.legalText": "2003 óta működő magyar vállalkozás, győri székhellyel és ellenőrizhető cégadatokkal.",
    "trust.processKicker": "Ajánlat után",
    "trust.processTitle": "24 órán belüli irány",
    "trust.processText": "Nem kötelező erejű ajánlatot adunk: először megértjük, mire kell dolgoznia a weboldalnak.",
    "trust.techKicker": "Mérhető alapok",
    "trust.techTitle": "HTTPS, mobil, SEO alap",
    "trust.techText": "Gyors statikus felépítés, többnyelvű tartalom, jogi oldalak és tiszta ajánlatkérési útvonal.",
    ...
    "prices.trustEyebrow": "Átlátható ajánlat",
    "prices.trustTitle": "Pontosan tudd, mire mondasz igent.",
    "prices.trustText": "Az első ajánlat nem kötelez semmire. Tételesen leírjuk a célokat, a tartalmi mennyiséget, a határidőt, a várható külön költségeket és az átadás módját.",
    "prices.trustIncludedTitle": "Ami minden projektben benne van",
    "prices.trustIncludedText": "Mobilnézet, kapcsolatfelvételi útvonal, alap SEO-struktúra, jogi oldalak vázai és technikai átadás.",
    "prices.trustExcludedTitle": "Ami külön egyeztetés",
    "prices.trustExcludedText": "Domain, tárhely, fizetős külső szolgáltatások, hirdetési költségek és jogi tanácsadás.",
    "prices.trustPaymentTitle": "Fizetés és indulás",
    "prices.trustPaymentText": "Nagyobb projektnél ütemezett mérföldkövekben dolgozunk, hogy végig átlátható legyen, hol tart a fejlesztés.",
  ...
  en: {
    ...
    "contact.trustTitle": "Free first response, with no obligation.",
    "contact.trustText": "If the form ever fails for a technical reason, write directly to: hello@da-technology.eu",
    "contact.companyNameLabel": "Company",
    "contact.companyTaxLabel": "Tax number",
    "contact.companyAddressLabel": "Registered office",
    "contact.proofResponseLabel": "Response time",
    "contact.proofResponseText": "Within 24 hours",
    "contact.proofStartLabel": "First step",
    "contact.proofStartText": "Free consultation",
    "contact.proofOfferLabel": "Offer",
    "contact.proofOfferText": "Clear, transparent direction",
    "form.name": "Name",
    ...
    "trust.legalKicker": "Company background",
    "trust.legalText": "A Hungarian company active since 2003, with registered office in Gyor and verifiable company details.",
    "trust.processKicker": "After the request",
    "trust.processTitle": "Clear direction within 24 hours",
    "trust.processText": "The first offer is not binding: first we understand what the website needs to achieve.",
    "trust.techKicker": "Measurable foundations",
    "trust.techTitle": "HTTPS, mobile, SEO base",
    "trust.techText": "Fast static build, multilingual content, legal pages and a clean request path.",
    ...
    "prices.trustEyebrow": "Transparent offer",
    "prices.trustTitle": "Know exactly what you are saying yes to.",
    "prices.trustText": "The first offer is not binding. We itemize the goals, content scope, deadline, expected external costs and handover method.",
    "prices.trustIncludedTitle": "Included in every project",
    "prices.trustIncludedText": "Mobile view, contact path, basic SEO structure, draft legal pages and technical handover.",
    "prices.trustExcludedTitle": "Agreed separately",
    "prices.trustExcludedText": "Domain, hosting, paid external services, advertising costs and legal advice.",
    "prices.trustPaymentTitle": "Payment and launch",
    "prices.trustPaymentText": "For larger projects we work in scheduled milestones so progress remains clear throughout development.",
  ...
  de: {
    ...
    "contact.trustTitle": "Kostenlose erste Rueckmeldung, ohne Verpflichtung.",
    "contact.trustText": "Falls das Formular aus technischen Gruenden nicht funktioniert, schreibe direkt an: hello@da-technology.eu",
    "contact.companyNameLabel": "Firma",
    "contact.companyTaxLabel": "Steuernummer",
    "contact.companyAddressLabel": "Sitz",
    "contact.proofResponseLabel": "Antwortzeit",
    "contact.proofResponseText": "Innerhalb von 24 Stunden",
    "contact.proofStartLabel": "Erster Schritt",
    "contact.proofStartText": "Kostenlose Abstimmung",
    "contact.proofOfferLabel": "Angebot",
    "contact.proofOfferText": "Klare, transparente Richtung",
    "form.name": "Name",
    ...
    "trust.legalKicker": "Unternehmenshintergrund",
    "trust.legalText": "Ungarisches Unternehmen seit 2003, mit Sitz in Gyor und pruefbaren Firmendaten.",
    "trust.processKicker": "Nach der Anfrage",
    "trust.processTitle": "Klare Richtung innerhalb von 24 Stunden",
    "trust.processText": "Das erste Angebot ist unverbindlich: Zuerst verstehen wir, was die Website leisten muss.",
    "trust.techKicker": "Messbare Grundlagen",
    "trust.techTitle": "HTTPS, Mobile, SEO-Basis",
    "trust.techText": "Schneller statischer Aufbau, mehrsprachiger Inhalt, rechtliche Seiten und klarer Anfrageweg.",
    ...
    "prices.trustEyebrow": "Transparentes Angebot",
    "prices.trustTitle": "Du weisst genau, wozu du Ja sagst.",
    "prices.trustText": "Das erste Angebot ist unverbindlich. Wir listen Ziele, Content-Umfang, Frist, erwartete externe Kosten und Uebergabe klar auf.",
    "prices.trustIncludedTitle": "In jedem Projekt enthalten",
    "prices.trustIncludedText": "Mobile Ansicht, Kontaktweg, SEO-Grundstruktur, Entwuerfe rechtlicher Seiten und technische Uebergabe.",
    "prices.trustExcludedTitle": "Separat abzustimmen",
    "prices.trustExcludedText": "Domain, Hosting, kostenpflichtige externe Dienste, Werbekosten und Rechtsberatung.",
    "prices.trustPaymentTitle": "Zahlung und Start",
    "prices.trustPaymentText": "Bei groesseren Projekten arbeiten wir mit geplanten Meilensteinen, damit der Fortschritt jederzeit klar bleibt.",
