...
Az endpoint Resend API-val küldi ki az ajánlatkérést Cloudflare Pages alatt.
...
Ha a `RESEND_API_KEY` nincs beállítva, a frontend hibát jelez, mert a mailto vázlatos fallback ki lett véve.
